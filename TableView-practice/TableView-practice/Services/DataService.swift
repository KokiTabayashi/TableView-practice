...
class DataService {
    ...
    private let hoodies = [
        ...
        Product(title: "Devslopes Logo Hoodie Black", price: "$32", imageName: "hoodie02.png"),
        Product(title: "Devslopes Logo Hoodie White", price: "$32", imageName: "hoodie03.png"),
        Product(title: "Devslopes Logo Hoodie Red", price: "$32", imageName: "hoodie04.png")
    ]
    ...
    private let shirts = [
        ...
        Product(title: "Devslopes Logo Shirt Red", price: "$18", imageName: "shirt04.png"),
        Product(title: "Devslopes Logo Shirt Blue", price: "$18", imageName: "shirt05.png")
    ]
